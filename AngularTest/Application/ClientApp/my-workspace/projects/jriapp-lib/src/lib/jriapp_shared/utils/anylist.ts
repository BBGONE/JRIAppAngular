...
export class AnyList extends BaseList<IAnyValItem, IAnyVal> {
  ...
  // override
  protected override createItem(obj?: IAnyVal): IAnyValItem {
    const isNew = !obj;
