...
export type TFileSystemObjectAspect = RIAPP.EntityAspect<FileSystemObject, IFileSystemObject, DbContext>;

export interface FileSystemObject extends IFileSystemObject, RIAPP.IEntityItem {
...
export class FileSystemObjectDb extends RIAPP.DbSet<FileSystemObject, IFileSystemObject, DbContext>
{
    ...
    createReadAllQuery(args?: {
        ...
        infoType: string;
    }): RIAPP.DataQuery<FileSystemObject, IFileSystemObject> {
